...
export const spreadsheetConfigTable = pgTable("spreadsheet_config", {
  ...
  // A-H are reserved by inventory sheet. Monitoring columns start from I.
  alertColumnIndex: integer("alert_column_index").default(11),
  ...
  lastCheckColumnIndex: integer("last_check_column_index").default(10),
  alertStatusColumnIndex: integer("alert_status_column_index").default(11),
  repricedValueColumnIndex: integer("repriced_value_column_index").default(12),
  evidenceUrlsColumnIndex: integer("evidence_urls_column_index").default(13),
  trackedTargetUrlColumnIndex: integer("tracked_target_url_column_index").default(14),
  trackedTargetConditionColumnIndex: integer("tracked_target_condition_column_index").default(15),
  trackedTargetPriceColumnIndex: integer("tracked_target_price_column_index").default(16),
