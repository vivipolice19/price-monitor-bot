...
router.post("/spreadsheet/config", async (req, res) => {
  ...
  try {
    ...
    const updateData: Record<string, any> = {
      spreadsheetId,
      sheetName,
      alertColumnIndex: alertColumnIndex ?? 6,
      ...
      lastCheckColumnIndex: lastCheckColumnIndex ?? 7,
      alertStatusColumnIndex: alertStatusColumnIndex ?? 10,
      repricedValueColumnIndex: repricedValueColumnIndex ?? 11,
      evidenceUrlsColumnIndex: evidenceUrlsColumnIndex ?? 12,
      trackedTargetUrlColumnIndex: trackedTargetUrlColumnIndex ?? 13,
      trackedTargetConditionColumnIndex: trackedTargetConditionColumnIndex ?? 14,
      trackedTargetPriceColumnIndex: trackedTargetPriceColumnIndex ?? 15,
    ...
    res.json({
      ...
      trackedTargetUrlColumnIndex: saved.trackedTargetUrlColumnIndex ?? 13,
      trackedTargetConditionColumnIndex: saved.trackedTargetConditionColumnIndex ?? 14,
      trackedTargetPriceColumnIndex: saved.trackedTargetPriceColumnIndex ?? 15,
