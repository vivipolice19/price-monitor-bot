...
router.get("/spreadsheet/config", async (req, res) => {
  try {
    ...
    res.json({
      ...
      lowestPriceColumnIndex: FIXED_MONITOR_COLUMNS.lowestPriceColumnIndex,
      lowestConditionColumnIndex: FIXED_MONITOR_COLUMNS.lowestConditionColumnIndex,
      lastCheckColumnIndex: FIXED_MONITOR_COLUMNS.lastCheckColumnIndex,
      alertStatusColumnIndex: FIXED_MONITOR_COLUMNS.alertStatusColumnIndex,
      repricedValueColumnIndex: FIXED_MONITOR_COLUMNS.repricedValueColumnIndex,
      evidenceUrlsColumnIndex: FIXED_MONITOR_COLUMNS.evidenceUrlsColumnIndex,
      trackedTargetUrlColumnIndex: FIXED_MONITOR_COLUMNS.trackedTargetUrlColumnIndex,
      trackedTargetConditionColumnIndex: FIXED_MONITOR_COLUMNS.trackedTargetConditionColumnIndex,
      trackedTargetPriceColumnIndex: FIXED_MONITOR_COLUMNS.trackedTargetPriceColumnIndex,
